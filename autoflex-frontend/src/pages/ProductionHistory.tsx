...
export default function ProductionHistory() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-4">Production History</h1>

      <div className="grid gap-4">
        {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
        {productions.map((production: any) => (
          <div key={production.id} className="bg-white shadow p-4 rounded">
            <div className="flex justify-between">
              <div>
                <p className="font-semibold">{production.product.name}</p>
                <p>Quantity: {production.quantityProduced}</p>
